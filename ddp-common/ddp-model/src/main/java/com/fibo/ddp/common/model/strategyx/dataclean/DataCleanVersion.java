...
@AllArgsConstructor
@NoArgsConstructor
@TableName("t_data_clean_version")
public class DataCleanVersion implements Serializable {
...
//    private String groupFields;
    ...
    */
    ...
    private List<DataCleanConditionAndOutPut> conditionAndOutPutList;

    @TableField(exist = false)
    private DataCleanOriginalDataOp originalDataOp;
}
