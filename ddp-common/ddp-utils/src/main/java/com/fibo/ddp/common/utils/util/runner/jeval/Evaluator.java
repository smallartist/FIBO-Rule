...
import com.fibo.ddp.common.utils.util.runner.jeval.function.math.MathFunctions;
import com.fibo.ddp.common.utils.util.runner.jeval.function.string.StringFunctions;
import com.fibo.ddp.common.utils.util.runner.jeval.operator.*;
...
public class Evaluator {
	...
	private int processOperator(final String expression,
		...
		if (operator instanceof OpenParenthesesOperator) {
			...
			// Process non-inputParam operator.
			if (operatorStack.size() > 0) {
