...
import com.fibo.ddp.common.utils.constant.OpTypeEnum;
...
public class ArchivesLogAspect {
       ...
       @Pointcut("@annotation(com.fibo.ddp.common.service.monitor.logger.ArchivesLog))")
	...
	public  void handleLog(JoinPoint joinPoint,Exception e,Object retValue) { 
    	try {
			...
			if(sysUser !=null){
				log.setOpUserId(sysUser.getUserId());
				log.setOrganId(sysUser.getOrganId());
			}
